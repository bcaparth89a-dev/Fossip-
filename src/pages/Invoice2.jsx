...
const Invoice2 = () => {
  ...
  const generatePDF = async () => {
    ...
    const tableRows = invoice.productsDetails
      .map(
        (product) => `
    <tr>
  ...
  `
    ...
    const htmlContent = `<!DOCTYPE html>
                      ...
                      .container {
                        background-color: #f9fafb; /* light gray look */
    ...
    try {
      const response = await axios.post(
        ...
        },
        {
          headers: {
            "x-api-key":
              "nobledabhoi1980@gmail.com_lksu0cbX4nuntgD41qa6lVEZtXWj2RbFmfea5Hq4JbaBPmUIQlT0RunlWNECmOLg", // 🔁 Replace this with your actual key
...
`.trim();
  ...
  const sendEmail = async () => {
    ...
    const productDetailsString = invoice.productsDetails
      .map((product, index) => {
      ...
      <div className="mt-15 mb-10 h-auto w-full max-w-[650px] bg-white border-4 border-gray-200 rounded-1xl shadow-[0_6px_20px_rgba(0,0,0,0.15)]">
        ...
        <div className="flex items-center w-full px-4 sm:px-6 md:px-8 lg:px-10 bg-white border-b border-gray-400 shadow-sm sticky top-0 z-50">
          ...
          <div className="flex-shrink-0">
            <button
              onClick={() => navigate(-1)}
              className="bg-gray-50 active:bg-gray-200 border border-gray-400 rounded my-3 w-9 h-7 sm:w-10 sm:h-8 flex items-center justify-center px-2 shadow"
            >
          ...
          <div className="flex space-x-2 sm:space-x-4 flex-shrink-0">
            ...
            <button
              onClick={handleGenerateUploadAndSend}
          ...
          <div>
            <div className="flex justify-center">
              <img
                src={LOGO2}
                alt="LOGO"
                className="h-[130px] sm:h-[150px] md:h-[170px] w-[210px] sm:w-[210px] md:w-[240px] mt-7 rounded-2xl border border-gray-300 shadow-lg "
              />
            </div>
                ...
                <table className="w-full border border-gray-400 border-collapse text-center text-xs sm:text-sm">
                  <thead>
                    <tr className="bg-gray-200">
                      <th className="border border-gray-400 px-2 py-[8px] sm:py-[4px]">
                        Product Code
                      </th>
                      <th className="border border-gray-400 px-2 py-[8px] sm:py-[4px]">
                        Description
          ...
          <div className="px-2 sm:px-6 md:px-10 lg:px-16 mt-8">
            ...
            <div className="mt-6">
              <h1 className="text-base sm:text-lg md:text-xl text-center font-semibold">
                WE DON'T HAVE ANY OTHER <br className="hidden sm:block" />{" "}
                FRANCHISE
              </h1>
            </div>
            <div className="mb-6">
